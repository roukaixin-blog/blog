package com.roukaixin.authorization.filter;
...
import com.roukaixin.constant.RedisConstant;
import com.roukaixin.pojo.OAuth2User;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (StringUtils.hasText(authorization)) {
            ...
            if (authorizationSplit.length == LENGTH) {
                ...
                String encrypt = AesUtils.decrypt(AES_KEY_ACCESS_TOKEN, accessToken);
